...
import { RlsFilesignDetail } from '../../../components/RlsDetail';
import PageHeaderLayout from '../../../layouts/PageHeaderLayout';
import styles from './AuditFsign.less';

const FormItem = Form.Item;

@connect(({ auditfsign, loading }) => ({
  auditfsign,
  loading: loading.models.auditfsign,
}))
@Form.create()
export default class AuditFsign extends PureComponent {
    state = {
        expandForm: false,
        selectedRows: [],
        selectedRowKeys:[],
    ...
    render() {
        const { auditfsign: { data, modalVisible }, loading, dispatch } = this.props;
        ...
        const modalProps = {
            ...
            onOk (data) {
                dispatch({
                    type: `auditfsign/approveinfo`,
                    payload: data,
                })
            },
            onCancel () {
                dispatch({
                    type: 'auditfsign/hideModal',
                })
            },
        }
        ...
        return (
            <PageHeaderLayout title="">
                ...
                {modalVisible &&  <RlsFilesignDetail { ...modalProps } />}
            </PageHeaderLayout>
        );
    }
}
