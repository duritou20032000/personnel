...
import { RlsCertDetail } from '../../../components/RlsDetail';
import PageHeaderLayout from '../../../layouts/PageHeaderLayout';
import styles from './AuditCert.less';

const FormItem = Form.Item;

@connect(({ auditcert, loading }) => ({
  auditcert,
  loading: loading.models.auditcert,
}))
@Form.create()
export default class AuditCert extends PureComponent {
    state = {
        expandForm: false,
        selectedRows: [],
        selectedRowKeys:[],
    ...
    render() {
        const { auditcert: { data, modalVisible }, loading, dispatch } = this.props;
        ...
        const modalProps = {
            ...
            onOk (data) {
                dispatch({
                    type: `auditcert/approveinfo`,
                    payload: data,
                })
            },
            onCancel () {
                dispatch({
                    type: 'auditcert/hideModal',
                })
            },
        }
        ...
        return (
            <PageHeaderLayout title="">
                ...
                {modalVisible &&  <RlsCertDetail { ...modalProps } />}
            </PageHeaderLayout>
        );
    }
}
