...
import { RlsSealDetail } from '../../../components/RlsDetail';
import PageHeaderLayout from '../../../layouts/PageHeaderLayout';
import styles from './AuditSeal.less';

const FormItem = Form.Item;

@connect(({ auditseal, loading }) => ({
  auditseal,
  loading: loading.models.auditseal,
}))
@Form.create()
export default class AuditSeal extends PureComponent {
    state = {
        expandForm: false,
        selectedRows: [],
        selectedRowKeys:[],
    ...
    render() {
        const { auditseal: { data, modalVisible }, loading, dispatch } = this.props;
        ...
        const modalProps = {
            ...
            onOk (data) {
                dispatch({
                    type: `auditseal/approveinfo`,
                    payload: data,
                })
            },
            onCancel () {
                dispatch({
                    type: 'auditseal/hideModal',
                })
            },
        }
        ...
        return (
            <PageHeaderLayout title="">
                ...
                {modalVisible &&  <RlsSealDetail { ...modalProps } />}
            </PageHeaderLayout>
        );
    }
}
